...
Don't get bogged down in perfection, formatting, or trying to sound overly academic. **Set a Pomodoro timer and start synthesizing your findings**. It is often easiest to start writing the body paragraphs first before tackling the introduction. If you get stuck, literally chat with yourself in the document (e.g., _"I'm not sure this makes sense but what I am trying to say is..."_) and highlight it to fix later.
