...
I wondered, _what does it mean for a product to be honest?_

Now after a little extra research and a couple days of reflection, I understand what he meant and how important this idea is for _any_ designer looking to make an impact with their work.
...
![McAfee’s fake malware notification. The notification makes it look like the user has been hacked in order to get them to use their service. Photo by Flavio Lameza.](https://miro.medium.com/v2/resize:fit:1036/1*P9UZgL1rp3n2tmI8fPkcqg.jpeg)

**Dishonest Design.** McAfee’s false malware notification. Used to hook users in out of fear of getting hacked. Photo by [Flavio Lameza](https://uxdesign.cc/stop-calling-these-dark-design-patterns-or-dark-ux-these-are-simply-asshole-designs-bb02df378ba).

![Google Now user preference page. The app has a series of drop down menus where users can adjust controls on their feedback algorithms.](https://miro.medium.com/v2/resize:fit:1000/1*aP1O0TDo_J0HtYWTLggRHw.png)

**Honest Design.** Google Now user preference page. Allows users to control the feedback algorithms.

![Fake notifications with the Restaurant 2 App on an iPhone home screen. The fake notifications attempt to trick users into opening the app by presenting empty notifications. Photo by Flavio Lameza.](https://miro.medium.com/v2/resize:fit:1152/1*cil6LrPkgxXyAgH78loDRQ.jpeg)

**Dishonest Design.** Fake notifications with the **Restaurant 2** App. Attempts to trick users into opening the app by highlighting empty notifications or “Variable Rewards”. Photo by [Flavio Lameza](https://uxdesign.cc/stop-calling-these-dark-design-patterns-or-dark-ux-these-are-simply-asshole-designs-bb02df378ba).
